            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.dataset.watch === "navigator") {
                        document.querySelector(`[data-goto].navigator-active`);
                        ...
                        if (entry.isIntersecting) navigatorCurrentItem ? navigatorCurrentItem.classList.add("navigator-active") : null; else navigatorCurrentItem ? navigatorCurrentItem.classList.remove("navigator-active") : null;
                    }
                }
            }
            if (getHash()) {
 ...
 */
        var jquery_dataTables_$ = jquery;
        var jquery_dataTables_DataTable = function(selector, options) {
            if (jquery_dataTables_DataTable.factory(selector, options)) return jquery_dataTables_DataTable;
            ...
            this.fnAddData = function(data, redraw) {
                ...
                if (redraw === void 0 || redraw) api.draw();
            ...
            this.fnAdjustColumnSizing = function(bRedraw) {
                ...
                if (bRedraw === void 0 || bRedraw) api.draw(false); else if (scroll.sX !== "" || scroll.sY !== "") _fnScrollDraw(settings);
            };
            this.fnClearTable = function(bRedraw) {
                var api = this.api(true).clear();
                if (bRedraw === void 0 || bRedraw) api.draw();
            };
            ...
            this.fnFilter = function(sInput, iColumn, bRegex, bSmart, bShowGlobal, bCaseInsensitive) {
                var api = this.api(true);
                if (iColumn === null || iColumn === void 0) api.search(sInput, bRegex, bSmart, bCaseInsensitive); else api.column(iColumn).search(sInput, bRegex, bSmart, bCaseInsensitive);
                api.draw();
            };
            ...
            this.fnGetPosition = function(node) {
                ...
                if (nodeName == "TR") return api.row(node).index(); else if (nodeName == "TD" || nodeName == "TH") {
            ...
            this.fnPageChange = function(mAction, bRedraw) {
                ...
                if (bRedraw === void 0 || bRedraw) api.draw(false);
            };
            this.fnSetColumnVis = function(iCol, bShow, bRedraw) {
                var api = this.api(true).column(iCol).visible(bShow);
                if (bRedraw === void 0 || bRedraw) api.columns.adjust().draw();
            };
            ...
            this.fnUpdate = function(mData, mRow, iColumn, bRedraw, bAction) {
                var api = this.api(true);
                if (iColumn === void 0 || iColumn === null) api.row(mRow).data(mData); else api.cell(mRow, iColumn).data(mData);
                if (bAction === void 0 || bAction) api.columns.adjust();
                if (bRedraw === void 0 || bRedraw) api.draw();
                return 0;
            };
            ...
            this.each((function() {
                ...
                if (jquery_dataTables_$.inArray(true, jquery_dataTables_$.map(stripeClasses, (function(el, i) {
                ...
                var loadedInit = function() {
                    ...
                    if (thead.length === 0) thead = jquery_dataTables_$("<thead/>").appendTo($this);
                    oSettings.nTHead = thead[0];
                    var tbody = $this.children("tbody");
                    if (tbody.length === 0) tbody = jquery_dataTables_$("<tbody/>").insertAfter(thead);
                    oSettings.nTBody = tbody[0];
                    var tfoot = $this.children("tfoot");
                    if (tfoot.length === 0 && captions.length > 0 && (oSettings.oScroll.sX !== "" || oSettings.oScroll.sY !== "")) tfoot = jquery_dataTables_$("<tfoot/>").appendTo($this);
                    if (tfoot.length === 0 || tfoot.children().length === 0) $this.addClass(oClasses.sNoFooter); else if (tfoot.length > 0) {
                        oSettings.nTFoot = tfoot[0];
                        _fnDetectHeader(oSettings.aoFooter, oSettings.nTFoot);
                    }
                    if (oInit.aaData) for (i = 0; i < oInit.aaData.length; i++) _fnAddData(oSettings, oInit.aaData[i]); else if (oSettings.bDeferLoading || _fnDataSource(oSettings) == "dom") _fnAddTr(oSettings, jquery_dataTables_$(oSettings.nTBody).children("tr"));
        ...
        jquery_dataTables_DataTable.util = {
            throttle: function(fn, freq) {
                var last, timer, frequency = freq !== void 0 ? freq : 200;
                return function() {
            ...
            set: function(source) {
                if (jquery_dataTables_$.isPlainObject(source)) return jquery_dataTables_DataTable.util.set(source._); else if (source === null) return function() {}; else if (typeof source === "function") return function(data, val, meta) {
                    ...
                    var fetchData = function(data, type, src) {
                        ...
                        if (src !== "") {
                            ...
                            for (var i = 0, iLen = a.length; i < iLen; i++) {
                                ...
                                if (data === null || data[a[i]] === null) return null; else if (data === void 0 || data[a[i]] === void 0) return;
                                data = data[a[i]];
                            }
                        }
                        return data;
        ...
        function _fnBrowserDetect(settings) {
            if (!jquery_dataTables_DataTable.__browser) {
                ...
                var n = jquery_dataTables_$("<div/>").css({
                    position: "fixed",
                    top: 0,
                    left: jquery_dataTables_$(window).scrollLeft() * -1,
                    height: 1,
                    width: 1,
                    overflow: "hidden"
        ...
        function _fnColumnOptions(oSettings, iCol, oOptions) {
            ...
            var bAsc = jquery_dataTables_$.inArray("asc", oCol.asSorting) !== -1;
            var bDesc = jquery_dataTables_$.inArray("desc", oCol.asSorting) !== -1;
        ...
        function _fnVisbleColumns(oSettings) {
            ...
            jquery_dataTables_$.each(oSettings.aoColumns, (function(i, col) {
                if (col.bVisible && jquery_dataTables_$(col.nTh).css("display") !== "none") vis++;
            }));
            return vis;
        }
        ...
        function _fnApplyColumnDefs(oSettings, aoColDefs, aoCols, fn) {
            ...
            if (aoColDefs) for (i = aoColDefs.length - 1; i >= 0; i--) {
                ...
                for (j = 0, jLen = aTargets.length; j < jLen; j++) if (typeof aTargets[j] === "number" && aTargets[j] >= 0) {
                    while (columns.length <= aTargets[j]) _fnAddColumn(oSettings);
                    fn(aTargets[j], def);
                } else if (typeof aTargets[j] === "number" && aTargets[j] < 0) fn(columns.length + aTargets[j], def); else if (typeof aTargets[j] === "string") for (k = 0, 
                kLen = columns.length; k < kLen; k++) if (aTargets[j] == "_all" || jquery_dataTables_$(columns[k].nTh).hasClass(aTargets[j])) fn(k, def);
            }
        ...
        function _fnAddData(oSettings, aDataIn, nTr, anTds) {
            ...
            if (id !== void 0) oSettings.aIds[id] = oData;
        ...
        function _fnGetCellData(settings, rowIdx, colIdx, type) {
            if (type === "search") type = "filter"; else if (type === "order") type = "sort";
            ...
            if ((cellData === rowData || cellData === null) && defaultContent !== null && type !== void 0) cellData = defaultContent; else if (typeof cellData === "function") return cellData.call(rowData);
        ...
        function _fnDeleteIndex(a, iTarget, splice) {
            ...
            if (iTargetIndex != -1 && splice === void 0) a.splice(iTargetIndex, 1);
        }
        function _fnInvalidate(settings, rowIdx, src, colIdx) {
            ...
            if (src === "dom" || (!src || src === "auto") && row.src === "dom") row._aData = _fnGetRowElements(settings, row, colIdx, colIdx === void 0 ? void 0 : row._aData).data; else {
                var cells = row.anCells;
                if (cells) if (colIdx !== void 0) cellWrite(cells[colIdx], colIdx); else for (i = 0, 
                ien = cells.length; i < ien; i++) cellWrite(cells[i], i);
            }
            row._aSortData = null;
            row._aFilterData = null;
            var cols = settings.aoColumns;
            if (colIdx !== void 0) cols[colIdx].sType = null; else {
        ...
        function _fnBuildHead(oSettings) {
            ...
            var createHeader = jquery_dataTables_$("th, td", thead).length === 0;
        ...
        function _fnDrawHead(oSettings, aoSource, bIncludeHidden) {
            ...
            if (!aoSource) return;
            if (bIncludeHidden === void 0) bIncludeHidden = false;
        ...
        function _fnDraw(oSettings, ajaxComplete) {
            ...
            if (jquery_dataTables_$.inArray(false, aPreDraw) !== -1) {
            ...
            if (aiDisplay.length !== 0) {
                ...
                if (oSettings.iDraw == 1 && _fnDataSource(oSettings) == "ajax") sZero = oLang.sLoadingRecords; else if (oLang.sEmptyTable && oSettings.fnRecordsTotal() === 0) sZero = oLang.sEmptyTable;
        ...
        function _fnAddOptionsHtml(oSettings) {
            ...
            for (var i = 0; i < aDom.length; i++) {
                ...
                } else if (cOption == ">") insert = insert.parent(); else if (cOption == "l" && features.bPaginate && features.bLengthChange) featureNode = _fnFeatureHtmlLength(oSettings); else if (cOption == "f" && features.bFilter) featureNode = _fnFeatureHtmlFilter(oSettings); else if (cOption == "r" && features.bProcessing) featureNode = _fnFeatureHtmlProcessing(oSettings); else if (cOption == "t") featureNode = _fnFeatureHtmlTable(oSettings); else if (cOption == "i" && features.bInfo) featureNode = _fnFeatureHtmlInfo(oSettings); else if (cOption == "p" && features.bPaginate) featureNode = _fnFeatureHtmlPaginate(oSettings); else if (jquery_dataTables_DataTable.ext.feature.length !== 0) {
        ...
        function _fnBuildAjax(oSettings, data, fn) {
            ...
            if (jquery_dataTables_$.isPlainObject(ajax) && ajax.data) {
                ...
                data = typeof ajaxData === "function" && newData ? newData : jquery_dataTables_$.extend(true, data, newData);
                delete ajax.data;
            }
            var baseAjax = {
                data,
                ...
                error: function(xhr, error, thrown) {
                    ...
                    if (jquery_dataTables_$.inArray(true, ret) === -1) if (error == "parsererror") _fnLog(oSettings, 0, "Invalid JSON response", 1); else if (xhr.readyState === 4) _fnLog(oSettings, 0, "Ajax error", 7);
                    _fnProcessingDisplay(oSettings, false);
                }
            };
            ...
            })), callback, oSettings); else if (oSettings.sAjaxSource || typeof ajax === "string") oSettings.jqXHR = jquery_dataTables_$.ajax(jquery_dataTables_$.extend(baseAjax, {
                url: ajax || oSettings.sAjaxSource
            })); else if (typeof ajax === "function") oSettings.jqXHR = ajax.call(instance, data, callback, oSettings); else {
        ...
        function _fnAjaxParameters(settings) {
            var i, dataProp, column, columnSearch, columns = settings.aoColumns, columnCount = columns.length, features = settings.oFeatures, preSearch = settings.oPreviousSearch, preColSearch = settings.aoPreSearchCols, data = [], sort = _fnSortFlatten(settings), displayStart = settings._iDisplayStart, displayLength = features.bPaginate !== false ? settings._iDisplayLength : -1;
        ...
        function _fnAjaxDataSrc(oSettings, json, write) {
            var dataSrc = jquery_dataTables_$.isPlainObject(oSettings.ajax) && oSettings.ajax.dataSrc !== void 0 ? oSettings.ajax.dataSrc : oSettings.sAjaxDataProp;
            if (!write) {
        ...
        function _fnFeatureHtmlFilter(settings) {
            ...
            var jqFilter = jquery_dataTables_$("input", filter).val(previousSearch.sSearch).attr("placeholder", language.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", searchDelay ? _fnThrottle(searchFn, searchDelay) : searchFn).on("mouseup.DT", (function(e) {
                setTimeout((function() {
        ...
        function _fnFilter(settings, input, force, regex, smart, caseInsensitive) {
            ...
            var filtered = [];
            if (jquery_dataTables_DataTable.ext.search.length !== 0) force = true;
            invalidated = _fnFilterData(settings);
            if (input.length <= 0) settings.aiDisplay = displayMaster.slice(); else {
                if (invalidated || force || regex || prevSearch.length > input.length || input.indexOf(prevSearch) !== 0 || settings.bSorted) settings.aiDisplay = displayMaster.slice();
        ...
        function _fnFeatureHtmlPaginate(settings) {
            var type = settings.sPaginationType, plugin = jquery_dataTables_DataTable.ext.pager[type], modern = typeof plugin === "function", redraw = function(settings) {
                _fnDraw(settings);
        ...
        function _fnPageChange(settings, action, redraw) {
            ...
            if (records === 0 || len === -1) start = 0; else if (typeof action === "number") {
                start = action * len;
                if (start > records) start = 0;
            } else if (action == "first") start = 0; else if (action == "previous") {
                start = len >= 0 ? start - len : 0;
                if (start < 0) start = 0;
            } else if (action == "next") {
                if (start + len < records) start += len;
            } else if (action == "last") start = Math.floor((records - 1) / len) * len; else _fnLog(settings, 0, "Unknown paging action: " + action, 5);
        ...
        function _fnFeatureHtmlTable(settings) {
            ...
            }).append(headerClone.removeAttr("id").css("margin-left", 0).append(captionSide === "top" ? caption : null).append(table.children("thead"))))).append(jquery_dataTables_$(_div, {
        ...
        function _fnConvertToWidth(widths, parent) {
            var els = [];
            var results = [];
            for (var i = 0; i < widths.length; i++) if (widths[i]) els.push(jquery_dataTables_$("<div/>").css("width", _fnStringToCss(widths[i])).appendTo(parent || document.body)); else els.push(null);
            for (i = 0; i < widths.length; i++) results.push(els[i] ? els[i][0].offsetWidth : null);
            jquery_dataTables_$(els).remove();
            return results;
        }
        ...
        function _fnSortFlatten(settings) {
            ...
            for (i = 0; i < nestedSort.length; i++) {
                ...
                for (k = 0, kLen = aDataSort.length; k < kLen; k++) {
                    ...
                    if (nestedSort[i]._idx === void 0) nestedSort[i]._idx = jquery_dataTables_$.inArray(nestedSort[i][1], aoColumns[iCol].asSorting);
                    aSort.push({
                        src: srcCol,
                        col: iCol,
                        dir: nestedSort[i][1],
        ...
        function _fnSortListener(settings, colIdx, append, callback) {
            ...
            var next = function(a, overflow) {
                var idx = a._idx;
                if (idx === void 0) idx = jquery_dataTables_$.inArray(a[1], asSorting);
            ...
            if (append && settings.oFeatures.bSortMulti) {
                ...
                if (sortIdx !== -1) {
                    ...
                    if (nextSortIdx === null) sorting.splice(sortIdx, 1); else {
        ...
        function _fnImplementState(settings, s, callback) {
            ...
            if (jquery_dataTables_$.inArray(false, abStateLoad) !== -1) {
                settings._bLoadingState = false;
                callback();
                return;
            }
            ...
            if (s.length !== void 0) if (api) api.page.len(s.length); else settings._iDisplayLength = s.length;
            ...
            if (s.search !== void 0) jquery_dataTables_$.extend(settings.oPreviousSearch, _fnSearchToHung(s.search));
            if (s.columns) {
                for (i = 0, ien = s.columns.length; i < ien; i++) {
                    var col = s.columns[i];
                    if (col.visible !== void 0) if (api) api.column(i).visible(col.visible, false); else columns[i].bVisible = col.visible;
                    if (col.search !== void 0) jquery_dataTables_$.extend(settings.aoPreSearchCols[i], _fnSearchToHung(col.search));
                }
        ...
        function _fnExtend(out, extender, breakRefs) {
            ...
            for (var prop in extender) if (extender.hasOwnProperty(prop)) {
                ...
                } else if (breakRefs && prop !== "data" && prop !== "aaData" && Array.isArray(val)) out[prop] = val.slice(); else out[prop] = val;
            }
            return out;
        }
        ...
        function _fnCallbackFire(settings, callbackArr, eventName, args) {
            ...
            if (eventName !== null) {
                ...
                if (table.parents("body").length === 0) jquery_dataTables_$("body").trigger(e, args);
                ret.push(e.result);
            }
            return ret;
        }
        ...
        function _fnRenderer(settings, type) {
            ...
            if (jquery_dataTables_$.isPlainObject(renderer) && renderer[type]) return host[renderer[type]] || host._; else if (typeof renderer === "string") return host[renderer] || host._;
            return host._;
        }
        ...
        var _toSettings = function(mixed) {
            ...
            if (!mixed) return []; else if (mixed.nTable && mixed.oApi) return [ mixed ]; else if (mixed.nodeName && mixed.nodeName.toLowerCase() === "table") {
                idx = jquery_dataTables_$.inArray(mixed, tables);
                return idx !== -1 ? [ settings[idx] ] : null;
            } else if (mixed && typeof mixed.settings === "function") return mixed.settings().toArray(); else if (typeof mixed === "string") jq = jquery_dataTables_$(mixed); else if (mixed instanceof jquery_dataTables_$) jq = mixed;
        ...
        jquery_dataTables_$.extend(_Api.prototype, {
                ...
                for (i = 0, ien = context.length; i < ien; i++) {
                    ...
                    if (type === "table") {
                        ...
                        for (j = 0, jen = items.length; j < jen; j++) {
                            item = items[j];
                            if (type === "cell") ret = fn.call(apiInst, context[i], item.row, item.column, i, j); else ret = fn.call(apiInst, context[i], item, i, j, rows);
                            if (ret !== void 0) a.push(ret);
                        }
                    }
                }
            ...
            pluck: function(prop) {
                var fn = jquery_dataTables_DataTable.util.get(prop);
        ...
        _Api.register = _api_register = function(name, val) {
            ...
            for (i = 0, ien = heir.length; i < ien; i++) {
                ...
                if (i === ien - 1) {
                    src.val = val;
                    src.type = typeof val === "function" ? "function" : jquery_dataTables_$.isPlainObject(val) ? "object" : "other";
        ...
        _api_register("draw()", (function(paging) {
            return this.iterator("table", (function(settings) {
                if (paging === "page") _fnDraw(settings); else {
        ...
        var __reload = function(settings, holdPosition, callback) {
            ...
            if (_fnDataSource(settings) == "ssp") _fnReDraw(settings, holdPosition); else {
                _fnProcessingDisplay(settings, true);
        ...
        var _selector_row_indexes = function(settings, opts) {
            ...
            if (_fnDataSource(settings) == "ssp") return search === "removed" ? [] : _range(0, displayMaster.length); else if (page == "current") for (i = settings._iDisplayStart, 
            ien = settings.fnDisplayEnd(); i < ien; i++) a.push(displayFiltered[i]); else if (order == "current" || order == "applied") {
                if (search == "none") a = displayMaster.slice(); else if (search == "applied") a = displayFiltered.slice(); else if (search == "removed") {
            ...
            } else if (order == "index" || order == "original") for (i = 0, ien = settings.aoData.length; i < ien; i++) if (search == "none") a.push(i); else {
        ...
        var __row_selector = function(settings, selector, opts) {
            ...
            var run = function(sel) {
                ...
                if (selInt !== null && jquery_dataTables_$.inArray(selInt, rows) !== -1) return [ selInt ]; else if (sel === null || sel === void 0 || sel === "") return rows;
                if (typeof sel === "function") return jquery_dataTables_$.map(rows, (function(idx) {
                    var row = aoData[idx];
                ...
                if (sel.nodeName) {
                    ...
                    if (rowIdx !== void 0) return aoData[rowIdx] && aoData[rowIdx].nTr === sel ? [ rowIdx ] : []; else if (cellIdx) return aoData[cellIdx.row] && aoData[cellIdx.row].nTr === sel.parentNode ? [ cellIdx.row ] : []; else {
        ...
        _api_register("rows()", (function(selector, opts) {
            if (selector === void 0) selector = ""; else if (jquery_dataTables_$.isPlainObject(selector)) {
                opts = selector;
                selector = "";
            }
        ...
        _api_register("rows.add()", (function(rows) {
            var newRows = this.iterator("table", (function(settings) {
                ...
                for (i = 0, ien = rows.length; i < ien; i++) {
                    row = rows[i];
                    if (row.nodeName && row.nodeName.toUpperCase() === "TR") out.push(_fnAddTr(settings, row)[0]); else out.push(_fnAddData(settings, row));
                }
                return out;
            }), 1);
        ...
        _api_register("row().data()", (function(data) {
            var ctx = this.context;
            if (data === void 0) return ctx.length && this.length ? ctx[0].aoData[this[0]]._aData : void 0;
        ...
        var __details_add = function(ctx, row, data, klass) {
            ...
            var addRow = function(r, k) {
                ...
                if (r.nodeName && r.nodeName.toLowerCase() === "tr") rows.push(r); else {
                ...
                api.on(colvisEvent, (function(e, ctx, idx, vis) {
                    ...
                    for (var i = 0, ien = data.length; i < ien; i++) {
                        ...
                        if (row._details) row._details.each((function() {
                            var el = jquery_dataTables_$(this).children("td");
        ...
        _api_register(_child_mth, (function(data, klass) {
            var ctx = this.context;
            if (data === void 0) return ctx.length && this.length ? ctx[0].aoData[this[0]]._details : void 0; else if (data === true) this.child.show(); else if (data === false) __details_remove(this); else if (ctx.length && this.length) __details_add(ctx[0], ctx[0].aoData[this[0]], data, klass);
            return this;
        }));
        ...
        _api_registerPlural("columns().visible()", "column().visible()", (function(vis, calc) {
            ...
            if (vis !== void 0) this.iterator("table", (function(settings) {
                ...
                if (calc === void 0 || calc) that.columns.adjust();
            }));
            return ret;
        }));
        ...
        _api_register("column.index()", (function(type, idx) {
            if (this.context.length !== 0) {
                ...
                if (type === "fromVisible" || type === "toData") return _fnVisibleToColumnIndex(ctx, idx); else if (type === "fromData" || type === "toVisible") return _fnColumnIndexToVisible(ctx, idx);
            }
        }));
        ...
        var __cell_selector = function(settings, selector, opts) {
            ...
            var run = function(s) {
                ...
                if (jquery_dataTables_$.isPlainObject(s)) return s.column !== void 0 && s.row !== void 0 && jquery_dataTables_$.inArray(s.row, rows) !== -1 ? [ s ] : [];
        ...
        _api_register("cells()", (function(rowSelector, columnSelector, opts) {
            if (jquery_dataTables_$.isPlainObject(rowSelector)) if (rowSelector.row === void 0) {
                opts = rowSelector;
                rowSelector = null;
            } else {
                opts = columnSelector;
        ...
        _api_register("search()", (function(input, regex, smart, caseInsen) {
            var ctx = this.context;
            if (input === void 0) return ctx.length !== 0 ? ctx[0].oPreviousSearch.sSearch : void 0;
            return this.iterator("table", (function(settings) {
        ...
        _api_registerPlural("columns().search()", "column().search()", (function(input, regex, smart, caseInsen) {
            return this.iterator("column", (function(settings, column) {
                ...
                if (input === void 0) return preSearch[column].sSearch;
                if (!settings.oFeatures.bFilter) return;
        ...
        jquery_dataTables_DataTable.use = function(module, type) {
            if (type === "lib" || module.fn) jquery_dataTables_$ = module; else if (type == "win" || module.document) {
                window = module;
                document = module.document;
            } else if (type === "datetime" || module.type === "DateTime") jquery_dataTables_DataTable.DateTime = module;
        };
        jquery_dataTables_DataTable.factory = function(root, jq) {
            var is = false;
        ...
        _api_register("destroy()", (function(remove) {
            ...
            return this.iterator("table", (function(settings) {
                ...
                if (idx !== -1) jquery_dataTables_DataTable.settings.splice(idx, 1);
            }));
        }));
        jquery_dataTables_$.each([ "column", "row", "cell" ], (function(i, type) {
            _api_register(type + "s().every()", (function(fn) {
                ...
                return this.iterator(type, (function(settings, arg1, arg2, arg3, arg4) {
                    fn.call(api[type](arg1, type === "cell" ? arg2 : opts, type === "cell" ? opts : void 0), arg1, arg2, arg3, arg4);
                }));
            }));
        }));
        _api_register("i18n()", (function(token, def, plural) {
            ...
            if (plural !== void 0 && jquery_dataTables_$.isPlainObject(resolved)) resolved = resolved[plural] !== void 0 ? resolved[plural] : resolved._;
            return typeof resolved === "string" ? resolved.replace("%d", plural) : resolved;
        }));
        jquery_dataTables_DataTable.version = "1.13.7";
        ...
        jquery_dataTables_DataTable.models.oSettings = {
            ...
            fnDisplayEnd: function() {
                ...
                if (features.bServerSide) return paginate === false || len === -1 ? start + records : Math.min(start + len, this._iRecordsDisplay); else return !paginate || calc > records || len === -1 ? records : calc;
            },
            oInstance: null,
            sInstance: null,
            iTabIndex: 0,
        ...
        jquery_dataTables_$.extend(true, jquery_dataTables_DataTable.ext.renderer, {
            pageButton: {
                _: function(settings, host, idx, buttons, page, pages) {
                    ...
                    if (activeEl !== void 0) jquery_dataTables_$(host).find("[data-dt-idx=" + activeEl + "]").trigger("focus");
                }
            }
        });
        ...
        if (window.Intl !== void 0) try {
            ...
            for (var i = 0; i < num.length; i++) if (num[i].type === "group") __thousands = num[i].value; else if (num[i].type === "decimal") __decimal = num[i].value;
        } catch (e) {}
 ...
 */
        let dataTables_responsive_$ = jquery;
        var Responsive = function(settings, opts) {
            ...
            this.c = dataTables_responsive_$.extend(true, {}, Responsive.defaults, jquery_dataTables.defaults.responsive, opts);
            settings.responsive = this;
            this._constructor();
        };
        dataTables_responsive_$.extend(Responsive.prototype, {
            _constructor: function() {
                var that = this;
                var dt = this.s.dt;
                var dtPrivateSettings = dt.settings()[0];
                var oldWindowWidth = dataTables_responsive_$(window).innerWidth();
                dt.settings()[0]._responsive = this;
                dataTables_responsive_$(window).on("resize.dtr orientationchange.dtr", jquery_dataTables.util.throttle((function() {
                    var width = dataTables_responsive_$(window).innerWidth();
                ...
                dtPrivateSettings.oApi._fnCallbackReg(dtPrivateSettings, "aoRowCreatedCallback", (function(tr, data, idx) {
                    if (dataTables_responsive_$.inArray(false, that.s.current) !== -1) dataTables_responsive_$(">td, >th", tr).each((function(i) {
                        var idx = dt.column.index("toData", i);
                        if (that.s.current[idx] === false) dataTables_responsive_$(this).css("display", "none");
                    }));
                }));
                dt.on("destroy.dtr", (function() {
                    dt.off(".dtr");
                    dataTables_responsive_$(dt.table().body()).off(".dtr");
                    dataTables_responsive_$(window).off("resize.dtr orientationchange.dtr");
                    dt.cells(".dtr-control").nodes().to$().removeClass("dtr-control");
                    dataTables_responsive_$.each(that.s.current, (function(i, val) {
                ...
                if (details.type !== false) {
                    ...
                    dataTables_responsive_$(dt.table().node()).addClass("dtr-" + details.type);
                }
                ...
                dt.on("draw.dtr", (function() {
                    ...
                    that._resizeAuto();
                    that._resize();
                    if (dataTables_responsive_$.inArray(false, that.s.current)) dt.columns.adjust();
                }));
                this._resize();
            },
            ...
            _columnsVisiblity: function(breakpoint) {
                ...
                var display = dataTables_responsive_$.map(columns, (function(col, i) {
                    if (dt.column(i).visible() === false) return "not-visible";
                    return col.auto && col.minWidth === null ? false : col.auto === true ? "-" : dataTables_responsive_$.inArray(breakpoint, col.includeIn) !== -1;
                }));
                var requiredWidth = 0;
                ...
                if (dataTables_responsive_$.inArray(true, display) === -1) display[0] = true;
                return display;
            },
            _classLogic: function() {
                ...
                var columns = dt.columns().eq(0).map((function(i) {
                    ...
                    if (priority === void 0) priority = dataPriority === void 0 || dataPriority === null ? 1e4 : dataPriority * 1;
                    return {
                        className,
                        includeIn: [],
                        auto: false,
                ...
                var add = function(colIdx, name) {
                    ...
                    if (dataTables_responsive_$.inArray(name, includeIn) === -1) includeIn.push(name);
                };
                var column = function(colIdx, name, operator, matched) {
                    var size, i, ien;
                    if (!operator) columns[colIdx].includeIn.push(name); else if (operator === "max-") {
                        size = that._find(name).width;
                        for (i = 0, ien = breakpoints.length; i < ien; i++) if (breakpoints[i].width <= size) add(colIdx, breakpoints[i].name);
                    } else if (operator === "min-") {
                        size = that._find(name).width;
                        for (i = 0, ien = breakpoints.length; i < ien; i++) if (breakpoints[i].width >= size) add(colIdx, breakpoints[i].name);
                    } else if (operator === "not-") for (i = 0, ien = breakpoints.length; i < ien; i++) if (breakpoints[i].name.indexOf(matched) === -1) add(colIdx, breakpoints[i].name);
                };
                columns.each((function(col, i) {
                    ...
                    for (var k = 0, ken = classNames.length; k < ken; k++) {
                        ...
                        if (className === "all" || className === "dtr-all") {
                            hasClass = true;
                            col.includeIn = dataTables_responsive_$.map(breakpoints, (function(a) {
                                return a.name;
                            }));
                            return;
            ...
            _controlClass: function() {
                if (this.c.details.type === "inline") {
                    ...
                    var firstVisible = dataTables_responsive_$.inArray(true, columnsVis);
            ...
            _detailsDisplay: function(row, update) {
                ...
                var event = function(res) {
                    dataTables_responsive_$(row.node()).toggleClass("parent", res !== false);
                    dataTables_responsive_$(dt.table().node()).triggerHandler("responsive-display.dt", [ dt, row, res, update ]);
                };
            ...
            _detailsInit: function() {
                ...
                that._tabIndexes();
                dataTables_responsive_$(dt.table().body()).on("keyup.dtr", "td, th", (function(e) {
                    if (e.keyCode === 13 && dataTables_responsive_$(this).data("dtr-keyboard")) dataTables_responsive_$(this).click();
                }));
                var target = details.target;
                var selector = typeof target === "string" ? target : "td, th";
                if (target !== void 0 || target !== null) dataTables_responsive_$(dt.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", selector, (function(e) {
                    if (!dataTables_responsive_$(dt.table().node()).hasClass("collapsed")) return;
                    ...
                    var row = dt.row(dataTables_responsive_$(this).closest("tr"));
                    if (e.type === "click") that._detailsDisplay(row, false); else if (e.type === "mousedown") dataTables_responsive_$(this).css("outline", "none"); else if (e.type === "mouseup") dataTables_responsive_$(this).trigger("blur").css("outline", "");
                }));
            },
            _detailsObj: function(rowIdx) {
                var that = this;
                var dt = this.s.dt;
                return dataTables_responsive_$.map(this.s.columns, (function(col, i) {
                    ...
                    return {
                        ...
                        rowIndex: rowIdx,
                        title: dtCol.sTitle !== null ? dtCol.sTitle : dataTables_responsive_$(dt.column(i).header()).text()
                    };
                }));
            },
            _find: function(name) {
            ...
            _resize: function(forceRedraw) {
                ...
                dataTables_responsive_$(dt.table().node()).toggleClass("collapsed", collapsedClass);
                var changed = false;
                var visible = 0;
                ...
                if (changed) {
                    dataTables_responsive_$(dt.table().node()).trigger("responsive-resize.dt", [ dt, this.s.current ]);
                    if (dt.page.info().recordsDisplay === 0) dataTables_responsive_$("td", dt.table().body()).eq(0).attr("colspan", visible);
                }
                that._controlClass();
            },
            _resizeAuto: function() {
                ...
                if (dataTables_responsive_$.inArray(true, dataTables_responsive_$.map(columns, (function(c) {
                    return c.auto;
                }))) === -1) return;
                if (!dataTables_responsive_$.isEmptyObject(this.s.childNodeStore)) dataTables_responsive_$.each(this.s.childNodeStore, (function(key) {
                    var idx = key.split("-");
                ...
                var clonedHeader = dataTables_responsive_$(dt.table().header().cloneNode(false)).appendTo(clonedTable);
                var clonedBody = dataTables_responsive_$(dt.table().body()).clone(false, false).empty().appendTo(clonedTable);
                ...
                dataTables_responsive_$(clonedBody).append(dataTables_responsive_$(dt.rows({
                    page: "current"
                }).nodes()).clone(false)).find("th, td").css("display", "");
                var footer = dt.table().footer();
                if (footer) {
                    var clonedFooter = dataTables_responsive_$(footer.cloneNode(false)).appendTo(clonedTable);
                    var footerCells = dt.columns().footer().filter((function(idx) {
                        return dt.column(idx).visible();
                    })).to$().clone(false).css("display", "table-cell");
                    dataTables_responsive_$("<tr/>").append(footerCells).appendTo(clonedFooter);
                }
                dataTables_responsive_$("<tr/>").append(headerCells).appendTo(clonedHeader);
                if (this.c.details.type === "inline") dataTables_responsive_$(clonedTable).addClass("dtr-inline collapsed");
                dataTables_responsive_$(clonedTable).find("[name]").removeAttr("name");
                dataTables_responsive_$(clonedTable).css("position", "relative");
                var inserted = dataTables_responsive_$("<div/>").css({
                    width: 1,
                    height: 1,
                    overflow: "hidden",
                    clear: "both"
            ...
            _responsiveOnlyHidden: function() {
                var dt = this.s.dt;
                return dataTables_responsive_$.map(this.s.current, (function(v, i) {
            ...
            _setColumnVis: function(col, showHide) {
                ...
                dataTables_responsive_$(dt.column(col).header()).css("display", display).toggleClass("dtr-hidden", !showHide);
                dataTables_responsive_$(dt.column(col).footer()).css("display", display).toggleClass("dtr-hidden", !showHide);
                dt.column(col).nodes().to$().css("display", display).toggleClass("dtr-hidden", !showHide);
                if (!dataTables_responsive_$.isEmptyObject(this.s.childNodeStore)) dt.cells(null, col).indexes().each((function(idx) {
            ...
            _tabIndexes: function() {
                ...
                if (typeof target === "number") dt.cells(null, target, {
                    ...
                    dataTables_responsive_$(target, dt.rows({
                        page: "current"
        ...
        Responsive.display = {
            childRow: function(row, update, render) {
                if (update) {
                    if (dataTables_responsive_$(row.node()).hasClass("parent")) {
            ...
            modal: function(options) {
                return function(row, update, render, closeCallback) {
                    if (!update) {
                        var close = function() {
                            modal.remove();
                            dataTables_responsive_$(document).off("keypress.dtr");
                            dataTables_responsive_$(row.node()).removeClass("parent");
                            closeCallback();
                        };
                        var modal = dataTables_responsive_$('<div class="dtr-modal"/>').append(dataTables_responsive_$('<div class="dtr-modal-display"/>').append(dataTables_responsive_$('<div class="dtr-modal-content"/>').data("dtr-row-idx", row.index()).append(render())).append(dataTables_responsive_$('<div class="dtr-modal-close">&times;</div>').click((function() {
                            close();
                        })))).append(dataTables_responsive_$('<div class="dtr-modal-background"/>').click((function() {
                            close();
                        }))).appendTo("body");
                        dataTables_responsive_$(row.node()).addClass("parent");
                        dataTables_responsive_$(document).on("keyup.dtr", (function(e) {
                            if (e.keyCode === 27) {
                                e.stopPropagation();
                                close();
                            }
                        ...
                        modal = dataTables_responsive_$("div.dtr-modal-content");
                        if (modal.length && row.index() === modal.data("dtr-row-idx")) modal.empty().append(render()); else return null;
                    }
        ...
        Responsive.renderer = {
            listHiddenNodes: function() {
                return function(api, rowIdx, columns) {
                    var that = this;
                    var ul = dataTables_responsive_$('<ul data-dtr-index="' + rowIdx + '" class="dtr-details"/>');
                    var found = false;
                    dataTables_responsive_$.each(columns, (function(i, col) {
                        if (col.hidden) {
                            var klass = col.className ? 'class="' + col.className + '"' : "";
                            dataTables_responsive_$("<li " + klass + ' data-dtr-index="' + col.columnIndex + '" data-dt-row="' + col.rowIndex + '" data-dt-column="' + col.columnIndex + '">' + '<span class="dtr-title">' + col.title + "</span> " + "</li>").append(dataTables_responsive_$('<span class="dtr-data"/>').append(that._childNodes(api, col.rowIndex, col.columnIndex))).appendTo(ul);
                            found = true;
                        }
                    }));
            ...
            listHidden: function() {
                return function(api, rowIdx, columns) {
                    var data = dataTables_responsive_$.map(columns, (function(col) {
                        var klass = col.className ? 'class="' + col.className + '"' : "";
                    ...
                    return data ? dataTables_responsive_$('<ul data-dtr-index="' + rowIdx + '" class="dtr-details"/>').append(data) : false;
                };
            },
            tableAll: function(options) {
                options = dataTables_responsive_$.extend({
                    tableClass: ""
                }, options);
                return function(api, rowIdx, columns) {
                    var data = dataTables_responsive_$.map(columns, (function(col) {
                    ...
                    return dataTables_responsive_$('<table class="' + options.tableClass + ' dtr-details" width="100%"/>').append(data);
                };
            }
        };
        Responsive.defaults = {
        ...
        var Api = dataTables_responsive_$.fn.dataTable.Api;
        Api.register("responsive()", (function() {
            return this;
        }));
        Api.register("responsive.index()", (function(li) {
            li = dataTables_responsive_$(li);
            return {
        ...
        Api.register("responsive.hasHidden()", (function() {
            var ctx = this.context[0];
            return ctx._responsive ? dataTables_responsive_$.inArray(false, ctx._responsive._responsiveOnlyHidden()) !== -1 : false;
        }));
        ...
        dataTables_responsive_$.fn.dataTable.Responsive = Responsive;
        dataTables_responsive_$.fn.DataTable.Responsive = Responsive;
        dataTables_responsive_$(document).on("preInit.dt.dtr", (function(e, settings, json) {
            if (e.namespace !== "dt") return;
            if (dataTables_responsive_$(settings.nTable).hasClass("responsive") || dataTables_responsive_$(settings.nTable).hasClass("dt-responsive") || settings.oInit.responsive || jquery_dataTables.defaults.responsive) {
                var init = settings.oInit.responsive;
                if (init !== false) new Responsive(settings, dataTables_responsive_$.isPlainObject(init) ? init : {});
            }
        }));
        null && DataTable;
 ...
 */
        ...
        async function loadСatalogueCustomers() {
            try {
                const response = await fetch("files/customers.json", {
                    method: "GET"
                });
                if (!response.ok) throw new Error("HTTP error " + response.status);
                const responseResult = await response.json();
                let id = responseResult.customers[responseResult.customers.length - 1].id;
                while (responseResult.customers.length < 256) {
                    id++;
                    let customer = {
                        id,
                        name: "Customer " + id,
                        company: "Company " + id,
                        phone_number: "(" + Math.floor(100 + Math.random() * 900) + ") " + Math.floor(100 + Math.random() * 900) + "-" + Math.floor(1e3 + Math.random() * 9e3),
                        email: "customer" + id + "@company.com",
                        country: "Country " + id,
                        status: Math.random() > .5 ? "Active" : "Inactive"
                    };
                    responseResult.customers.push(customer);
                }
                $("#example").DataTable({
                    dom: "f,t,i,p",
                    pageLength: 8,
                    ...
                    language: {
                        paginate: {
                            previous: '<i class="icon-arrow"></i>',
                            next: '<i class="icon-arrow"></i>'
                        }
                    },
                    columnDefs: [ {
                        targets: "_all",
                        ...
                        createdCell: function(td, cellData, rowData, row, col) {
                            if (rowData.status == "Active") $(td).addClass("active-cell"); else if (rowData.status == "Inactive") $(td).addClass("inactive-cell");
                        }
                    } ],
                    data: responseResult.customers,
                    columns: [ {
                        data: "name"
                    }, {
                        data: "company"
                        ...
                        render: function(data, type, row) {
                            return '<div class="status-box">' + data + "</div>";
                        }
                    } ]
                });
                jquery((function($) {
